...
@section('extra_scripts')
    ...
    <script type="text/javascript">
        $("#schedules").children().addClass('active');
                    ...
                    $.each(result, function(index, value){
                        if(value.object.description != null){
                            $('#tableBodyNextClasses').append(
                                '<tr style="font-size: 0.9em;" class="rowNextClasses" id="rowSchedule-'+value.object.id+'"><td>'+value.object.id+'</td><td>'+value.formatDay+'</td><td>'+value.formatHour+'</td><td>'+value.object.instructor_name+'</td><td>'+value.object.description+'</td><td>'+value.object.reservation_limit+'</td><td>'+value.reservedBikes+'</td><td>'+value.availableBikes+'</td><td>'+value.object.branch_name+'</td><td class="text-center"><button class="btn btn-primary btn-sm editSchedule text-center" id="editSchedule-'+value.object.id+'" value="'+value.object.id+'" data-myid="'+value.object.id+'" data-myday="'+value.object.day+'" data-myhour="'+value.object.hour+'" data-myinstructor="'+value.object.instructor_id+'"data-mydescription="'+value.object.description+'" data-myreservation="'+value.object.reservation_limit+'" data-mybranch="'+value.object.branch_id+'" data-toggle="modal" data-target="#editScheduleModal">Editar</button></td><td class="text-center"><button class="btn btn-danger btn-sm deleteSchedule text-center" id="deleteSchedule-'+value.object.id+'" value="'+value.object.id+'">Eliminar</button></td></tr>',
                            );
                        } else {
                            $('#tableBodyNextClasses').append(
                                '<tr style="font-size: 0.9em;" class="rowNextClasses" id="rowSchedule-'+value.object.id+'"><td>'+value.object.id+'</td><td>'+value.formatDay+'</td><td>'+value.formatHour+'</td><td>'+value.object.instructor_name+'</td><td><i>Sin descripción</i></td><td>'+value.object.reservation_limit+'</td><td>'+value.reservedBikes+'</td><td>'+value.availableBikes+'</td><td>'+value.object.branch_name+'</td><td class="text-center"><button class="btn btn-primary btn-sm editSchedule text-center" id="editSchedule-'+value.object.id+'" value="'+value.object.id+'" data-myid="'+value.object.id+'" data-myday="'+value.object.day+'" data-myhour="'+value.object.hour+'" data-myinstructor="'+value.object.instructor_id+'"data-mydescription="'+value.object.description+'" data-myreservation="'+value.object.reservation_limit+'" data-mybranch="'+value.object.branch_id+'" data-toggle="modal" data-target="#editScheduleModal">Editar</button></td><td class="text-center"><button class="btn btn-danger btn-sm deleteSchedule text-center" id="deleteSchedule-'+value.object.id+'" value="'+value.object.id+'">Eliminar</button></td></tr>',
                            );
                        }
                    });
