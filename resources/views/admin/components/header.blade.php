            ...
            <ul class="header-nav header-nav-profile">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu animation-dock">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-fw fa-power-off text-danger"></i>Cerrar sesi&oacute;n</a>
