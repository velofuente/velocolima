    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (schedules.length === 0) {
                $('#calendario').html('<h4 class="text-center text-white">Aún no hay clases disponibles.</h4>');
            ...
            products.forEach(product => {
                ...
                var h3Class = product.promotional == 1 ? 'amountDeal' : 'amount6';
                ...
                <h3 id="amountDeal">${product.n_classes}</h3><h4 class="class">${prefixClass}</h4><p class="precio" style="font-size: 17px; font-family: 'Avenir Next Condensed'; font-weight: 300;">$${product.price}</p><p class="exp" style="font-size: 17px;">Expira: ${product.expiration_days} días</p>`);
